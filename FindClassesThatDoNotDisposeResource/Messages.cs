    ...
    public static class Messages
    {
        ...
        private static readonly Dictionary<string, MultilangMessage> Dictionary =
            new Dictionary<string, MultilangMessage>
            {
                ...
                { "ValidationExceptionClassWrongDefined", new MultilangMessage("No se pudo encontrar el tipo: {0}. Revise que el valor de la clave '{1}, incluya el espacio de nombres.", "The type could not be found: {0}. Check that the value for key '{1}' includes the namespace.") },
